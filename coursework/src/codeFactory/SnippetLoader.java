...
public class SnippetLoader {
    ...
    private static final String patternPath = "src\\codeSnippets\\PatternSnippets.txt";
    private static final String structPath = "src\\codeSnippets\\StructureSnippets.txt";
